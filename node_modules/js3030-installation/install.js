...
try {
    ...
    files.createLocalFile('configs', 'dependencies.json', JSON.stringify({
        'modules': [
            {'js3030-week1': 'weeks1-2'},
            {'js3030-week2': 'weeks3-4'},
            {'js3030-week3': 'weeks5-6'},
            {'js3030-week4': 'weeks7-8'}
        ],
...
try {
    ...
    pkg['dependencies']['spiritdependencies'] = '^0.1.65';
    pkg['dependencies']['spirittests'] = '^0.3.17';
