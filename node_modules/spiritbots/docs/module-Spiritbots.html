...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: Spiritbots</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: Spiritbots</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Robots is a simple pub/sub message bus with async capabilities</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        ...
        <dl>
            <dt><a href="module-Spiritbots-Robots.html">Robots</a></dt>
            <dd></dd>
        </dl>
...
<span class="param-type">Array.&lt;String, number, Boolean></span>
