...
var settings = configs.spiritbots;
...
var RobotsClass  = (function(){
     ...
     * @param {Object} meta object to supply miscellaneous options
     * @return {*}
     */
    this.RegisterOnce   = function(signal, callback, description, meta) {
        var obj = this;
        ...
        var cb = {'onetime':true,'fn':callback,'description': description,'meta': meta};
     ...
     * @return {Signal}
     */
    this.Register   = function(signal, callback, description, meta) {
        var signals;
        var obj = this;
        if ( Array.isArray(signal) ) {
            signals = signal;
        ...
        var cb = {'onetime':false,'fn':callback,'description': description,'meta': meta};
    ...
    this.copy = function() {
        ...
        if (settings.hasOwnProperty('allowNetwork') &&
            ...
            if (settings.hasOwnProperty('manualAPIStart') &&
                !settings['manualAPIStart'])
                obj.api.open();
