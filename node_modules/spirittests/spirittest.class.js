...
class SpiritTests {
    ...
    overrideJasmine() {
        ...
        it = (function(description, fn) {
            ...
            if (!this.suites.hasOwnProperty(this.currentSuite)) {
                ...
                if (!this.executions.hasOwnProperty(this.currentExecution)) {
                    this.executions[this.currentExecution] = {
                        suites: {},
                        created: (new Date()).getTime(),
                        lastUpdated: (new Date()).getTime()
                    };
                ...
                this.executions[this.currentExecution]
                    .suites[this.currentSuite] = this.suites[this.currentSuite];
            }
            suite = this.currentSuite.toString();
            spec = {};
            specMeta = {
            ...
            if (isAsync) {
                ...
                fnWrapper = (function() {
                    ...
                    if (spec.result.failedExpectations.length > 0) {
                        ...
                        visit.event('Tests-Passed', 
                            specMeta.description, 
                            this.configs['tests']['ua-uuid'], 0).send();
                    }
                    this.suites[suite].lastUpdated = 
                        (new Date()).getTime();
                }).bind(this);
            }
            spec = this.overriddenIt.call(this.jasmine.env, 
                description, fnWrapper);
            this.suites[this.currentSuite].specs.push(specMeta);
        }).bind(this);
