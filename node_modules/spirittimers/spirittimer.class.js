...
class SpiritTimer {
     ...
     * @param {Object} options Options object extends functionality of timer.
     */
    constructor(callbackFn, interval, options) {
        ...
        /**
         * If true, the file has been saved or recorded on the filesystem.
         * When SpiritTimer.fromFile is called, saed is initialized to true.
         */
        this.saved = false;
         ...
         * @type {Boolean}
         */
        this.temporary = (options && options.temporary) || false;
    }
    ...
    execute(timestamp) {
        ...
        console.log(this.saved, this.filename, this.temporary);
        if (this.filename.length > 0 && this.saved) {
            this.saveStatus(this.temporary);
        }
    ...
    getStatusFileContents() {
        return JSON.stringify(this.statuses);
    }
    ...
    save(temporary) {
        ...
        this.files.createLocalFile('timers', `${this.name.length > 0 ?
                this.name : this.getId()}.js`,
